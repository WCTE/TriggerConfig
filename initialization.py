...
def set_signal_channels(c, verbose = False):
    ...
    c.set_digitizer_board_connection("2", "1", "input", "12", verbose)
    c.set_digitizer_board_connection("2", "2", "input", "13", verbose)
    c.set_digitizer_board_connection("2", "3", "input", "14", verbose)
    c.set_digitizer_board_connection("2", "4", "input", "15", verbose)
    c.set_digitizer_board_connection("2", "5", "input", "16", verbose)
    c.set_digitizer_board_connection("2", "6", "input", "17", verbose)
    c.set_digitizer_board_connection("2", "7", "input", "18", verbose)
    c.set_digitizer_board_connection("2", "8", "input", "19", verbose)
    c.set_digitizer_board_connection("2", "9", "input", "20", verbose)
    ...
    c.set_digitizer_board_connection("2", "13", "input", "24", verbose)
    c.set_digitizer_board_connection("2", "14", "input", "25", verbose)
    ...
    c.set_digitizer_board_connection("2", "15", "input", "42", verbose)
    c.set_digitizer_board_connection("2", "16", "input", "43", verbose)
    c.set_digitizer_board_connection("2", "17", "input", "44", verbose)
    c.set_digitizer_board_connection("2", "18", "input", "45", verbose)
    c.set_digitizer_board_connection("2", "19", "input", "46", verbose)
...
def configure_le_trigger(short_name: str, description: str, filename: str):
    ...
    set_signal_channels(le, verbose = False)

    # setup the trigger logic
    setup_le_trigger_logic(le, verbose = True)
    ...
    le.set_trigger_board_connection("0", "1", "lemo", "1", verbose = True)
    ...
    le.set_deadtime_veto("625", verbose = True)
...
def configure_tp_trigger(short_name: str, description: str, filename: str):
    ...
    # setup the trigger logic
    setup_tp_trigger_logic(tp, verbose = True)
